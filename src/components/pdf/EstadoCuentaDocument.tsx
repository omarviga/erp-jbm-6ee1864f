    ...
    <Page size="LETTER" style={styles.page}>
      ...
      <View style={styles.header}>
        <View style={styles.logoSection}>
          <Text style={styles.companyName}>JBM CÍTRICOS</Text>
          <Text style={styles.companyDetails}>Carretera Nacional Km 45</Text>
          <Text style={styles.companyDetails}>Martínez de la Torre, Veracruz</Text>
          <Text style={styles.companyDetails}>Tel: (232) 123-4567</Text>
        </View>
