...
type SelectedRoleState = Partial<Record<string, AppRole>>;
...
export default function AdminUsuarios() {
  ...
  const [selectedRole, setSelectedRole] = useState<SelectedRoleState>({});
  ...
  // Redirect non-admin users after hooks have been declared to preserve hook order.
  if (!isAdmin) {
