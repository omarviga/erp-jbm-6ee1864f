...
const DashboardFinanceChart = lazy(() =>
  import("@/components/bodega-cdmx/DashboardFinanceChart").then((module) => ({ default: module.DashboardFinanceChart })),
);
...
export default function DashboardTab() {
  ...
  const costoMercancia = auditoriaData?.reduce((sum, a) => {
    const precioBase = (a as AuditoriaInventarioRow).inventario?.precio_base || 0;
  ...
  return (
    <div className="h-full flex flex-col p-6 overflow-auto bg-background">
      ...
      <div className="grid lg:grid-cols-2 gap-6 flex-1">
        <Suspense fallback={<div className="h-[360px] rounded-xl border bg-white animate-pulse" />}>
          <DashboardFinanceChart chartData={chartData} />
        </Suspense>
