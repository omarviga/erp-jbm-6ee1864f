...
export default function CorteCajaCDMX() {
  ...
  const realizarCorte = async () => {
    ...
    try {
      ...
      // Call the DB function to calculate theoretical cash (operator NEVER sees this before submitting)
      ...
      // NOW show the result to the operator
      setResultado({
        efectivo_teorico: teorico,
        efectivo_fisico: efectivo,
        diferencia,
  ...
  return (
    <MainLayout title="Corte de Caja" subtitle="Bodega CDMX — Auditoría ciega de efectivo">
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <Card className="shadow-industrial-lg">
          ...
          <CardContent className="space-y-6">
            {!resultado ? (
              ...
              /* Result revealed AFTER submission */
              <div className="space-y-6">
                <div className={`rounded-lg p-6 text-center ${
                  resultado.diferencia === 0 ? 'bg-success/10 border border-success/30' :
                  resultado.diferencia < 0 ? 'bg-destructive/10 border border-destructive/30' :
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  ...
                  <div>
                    ...
                    <p className={`text-xl font-bold font-mono ${
                      resultado.diferencia < 0 ? 'text-destructive' :
                      resultado.diferencia > 0 ? 'text-warning' : 'text-success'
                    }`}>
        ...
        {/* Right: History (admin only sees full detail) */}
        <Card>
          <CardHeader>
                ...
                {cortesHistorial.map((corte) => (
                  <div
                    ...
                    className={`border rounded-lg p-3 ${
                      (corte.diferencia || 0) < 0 ? 'border-destructive/40 bg-destructive/5' :
                      (corte.diferencia || 0) > 0 ? 'border-warning/40 bg-warning/5' :
                      'border-border'
                    }`}
                  >
