      ...
      <MainLayout title="📦 Inventarios" subtitle="Cámara Fría, Piso Empaque, Directo a Transporte y Transferencias CDMX">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <Card className={cn("border-l-4", lotesRojos > 0 ? "border-l-rose-500" : "border-l-emerald-500")}>
            <CardContent className="p-4">
              <p className="text-xs uppercase text-muted-foreground font-bold">Semáforo de rotación</p>
                ...
                <Card>
                  <CardHeader className="border-b">
                    <CardTitle className="text-base flex items-center gap-2">
                      <Snowflake className="h-4 w-4 text-blue-500" /> Cuadrícula de rotación (Cámara Fría)
                    </CardTitle>
                  </CardHeader>
