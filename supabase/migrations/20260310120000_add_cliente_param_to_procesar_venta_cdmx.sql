-- Extiende procesar_venta_cdmx para aceptar cliente opcional y evitar pagos_clientes.cliente_id NULL

-- Nueva firma con cliente opcional
...
BEGIN
  ...
  -- Cliente final: usar cliente recibido o fallback a Público en general
...
-- Mantener compatibilidad de firma antigua (3 args)
CREATE OR REPLACE FUNCTION public.procesar_venta_cdmx(
  p_items JSONB,
  p_metodo_pago TEXT,
  p_monto_total DECIMAL
